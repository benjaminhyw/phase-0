...
#A hash works just like an array in the sense that it stores elements with information.
#The difference however is that with a hash, you do not follow an ordered list format.
#You use other objects instead, rather than an index number.
